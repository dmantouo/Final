...
public interface SctMapper {
    ...
    @Select("select\n" +
            ...
            "from sct s \n" +
            "INNER JOIN user stu on stu.sno=s.sno\n" +
    ...
    @Select("select c.cno,t.tname,c.cname,c.ccredit,count(s.sno) total from sct s\n" +
            "INNER JOIN course c on c.cno=s.cno\n" +
            "INNER JOIN teacher t on t.cno1=s.cno or t.cno2=s.cno or t.cno3=s.cno\n" +
            "where c.cname like '%${cname}%' group by  c.cno,t.tname,c.cname,c.ccredit limit ${currentPage},${pageSize} ")
    ...
    @Select("select t.tname,c.cname,c.ccredit,count(s.sno) total from sct s\n" +
            "INNER JOIN course c on c.cno=s.cno\n" +
            "INNER JOIN teacher t on t.cno1=s.cno or t.cno2=s.cno or t.cno3=s.cno\n" +
            "where 1=1 and c.cname like '%${cname}%' group by t.tname,c.cname,c.ccredit ")
    ...
    @Select("select s.sname,t.tname,c.cno,c.cname,c.ccredit,xuan.* from sct xuan \n" +
            "INNER join user s on s.sno=xuan.sno\n" +
    ...
    @Select("select s.sname,t.tname,c.cno,c.cname,c.ccredit,xuan.* from sct xuan \n" +
            ...
            "INNER JOIN teacher t on t.tno=xuan.tno\n" +
            "INNER JOIN course c on c.cno=xuan.cno\n" +
            "where s.sname like '%${sname}%' and xuan.tno=${tno} limit ${currentPage},${pageSize}")
    List<Map<String,Object>> selectSctByPageAndCondition(@Param("sname")String sname,@Param("currentPage")int currentPage,
                                                         @Param("pageSize")int pageSize, String tno);
