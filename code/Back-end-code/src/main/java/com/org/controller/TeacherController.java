...
public class TeacherController {
    ...
    public Msg addTeacher(@RequestParam("tno")String tno, @RequestParam("tname")String tname,
                          ...
                          @RequestParam(required = false,value="cno3")String cno3,
                          @RequestParam("spassword")String spassword, @RequestParam("sid")String sid,
                          HttpServletRequest request, HttpServletResponse response){
        return teacherServiceImpl.addTeacher(tno,tname,tsex,tage,teb,tpt,cno1,cno2,cno3,spassword, sid,request,response);
    }
}
